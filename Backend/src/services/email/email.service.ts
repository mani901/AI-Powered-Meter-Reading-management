...
export async function sendVerifyEmail(args: { to: string; token: string; name: string }) {
...
export async function sendResetPasswordEmail(args: { to: string; token: string; name: string }) {
